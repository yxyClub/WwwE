...
Python：Py2.7和 Py3.6，看起来是机器自带的（此处略过我卸载 Anaconda 的大坑，有兴趣可以点[这里](http://xiaoyan.work/blog/2018/12/14/PythonEnvConfigBestPractice/)）。
...
xiaoyanMacBook-Pro:~ yyy$ python3
Python 3.6.1 (v3.6.1:69c0db5050, Mar 21 2017, 01:21:04) 
[GCC 4.2.1 (Apple Inc. build 5666) (dot 3)] on darwin
Type "help", "copyright", "credits" or "license" for more information.
>>> exit()
xiaoyanMacBook-Pro:~ yyy$ python
...
> 可以看到我的 py2是 py2.7.14，大妈这次教程的初始环境是2.7.15，这个回头我还要单独升级一下【待填坑】。
...
其实我主要是卡在环境配置这块了。因为我对于命令行基本没用过。对于一些程序员可以一看就看明白的提示，我的理解是有偏差的，也就说是，还是那句话，要`找官方文档`！

## 官方文档有哪些呢？

首先当然是 gitlab 的官方文档，然后是蟒营的 wiki（虽然可读性比较差~很多话看的云里雾里想敲电脑，然而我可写好了也可以贡献 wiki吧）。

### [Gitlab 的官方文档](https://docs.gitlab.com/ee/README.html)：

![image.png](https://upload-images.jianshu.io/upload_images/3785456-cb9868259acca11a.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

当然对于小白来说，最重要的是要看：

- [Git和GitLab的新手？](https://docs.gitlab.com/ee/README.html)

  - [命令行基本命令](https://docs.gitlab.com/ee/gitlab-basics/command-line-commands.html)
  - [在命令行上开始使用Git](https://docs.gitlab.com/ee/gitlab-basics/start-using-git.html#add-your-git-username-and-set-your-email)
  - [创建并添加SSH密钥](https://docs.gitlab.com/ee/gitlab-basics/create-your-ssh-keys.html)
  - [创建一个项目](https://docs.gitlab.com/ee/gitlab-basics/create-project.html)
  - [创建一个组](https://docs.gitlab.com/ee/user/group/index.html#create-a-new-group)
  - [创建一个分支](https://docs.gitlab.com/ee/gitlab-basics/create-branch.html)
  - [叉一个项目](https://docs.gitlab.com/ee/gitlab-basics/fork-project.html)
  - [添加文件](https://docs.gitlab.com/ee/gitlab-basics/add-file.html)
  - [添加图片](https://docs.gitlab.com/ee/gitlab-basics/add-image.html)
  - [创建一个问题](https://docs.gitlab.com/ee/user/project/issues/create_new_issue.html)
  - [创建合并请求](https://docs.gitlab.com/ee/gitlab-basics/add-merge-request.html)


- [GitLab辅助软件安装路径](https://about.gitlab.com/install/)

> 然而大妈并不推荐使用这些软件，而是推荐只是使用命令行，CommandLine

- [Mac OS X命令行简介](https://blog.teamtreehouse.com/introduction-to-the-mac-os-x-command-line)

- [macOS 终端(Terminal) 命令行 教程](https://www.jianshu.com/p/a9bf79b1b134?utm_campaign=maleskine&utm_content=note&utm_medium=seo_notes&utm_source=recommendation)
